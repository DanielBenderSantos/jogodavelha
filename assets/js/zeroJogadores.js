	...
	if ((mat[0][0] == mat[0][1]) && (mat[0][0] == mat[0][2])) { //  1/2/3
		if (mat[0][0] != undefined) {
			if (mat[0][0] == 0) {
				...
				j2 = Number(localStorage.getItem("zeroJogadoresJogador2")) + Number(1);
				localStorage.setItem("zeroJogadoresJogador2", j2)
			}
			else {
				document.getElementById("vencedor").innerHTML = ("Jogador 1 ganhou")
				document.getElementById("body").id = "body2"
				j1 = Number(localStorage.getItem("zeroJogadoresJogador1")) + Number(1);
				localStorage.setItem("zeroJogadoresJogador1", j1)
			}
			continua = 1
		}
	}
...
function zerar(link) {
	localStorage.removeItem("zeroJogadoresJogador1")
	localStorage.removeItem("zeroJogadoresJogador2")
	window.location.href = link
}

function verPlacar() {
	document.getElementById("saidaZeroJogadoresJogador1").innerHTML = localStorage.getItem("zeroJogadoresJogador1")
	document.getElementById("saidaZeroJogadoresJogador2").innerHTML = localStorage.getItem("zeroJogadoresJogador2")
